...
void maakLogo(/*unsigned int grootte*/)
{
    ...
    const float rode_hoeken[] = {
        -0.9 / SCHERM_BREEDTE * SCHERM_HOOGTE * 0.15, 1 * 0.015, -0.1,
        -0.7 / SCHERM_BREEDTE * SCHERM_HOOGTE * 0.15, -2.5 * 0.015, -0.1,
        1.0 / SCHERM_BREEDTE * SCHERM_HOOGTE * 0.15, 1 * 0.015, -0.1};
